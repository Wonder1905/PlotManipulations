...
class CTCAuxWrapper(nn.Module):
    ...
    def forward(self, x, batch_1):
        ...
        return ctc_loss, (out_title_char, title), (legends_outchar, legend_of_plots[0])
